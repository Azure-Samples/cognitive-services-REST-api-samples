...
namespace Microsoft.Azure.CognitiveServices.Samples.ComputerVision.GetAreaOfInterest
{
    ...
    public class GetAreaOfInterestSample
    {
        public static async Task RunAsync(string endpoint, string key)
        {
            ...
            await GetAreaOfInterestFromUrlAsync(remoteImageUrl, endpoint, key);
        }

        static async Task GetAreaOfInterestFromStreamAsync(string imageFilePath, string endpoint, string subscriptionKey)
        {
            ...
            try
            {
                ...
                string uri = $"{endpoint}/vision/v2.0/areaOfInterest";
        ...
        static async Task GetAreaOfInterestFromUrlAsync(string imageUrl, string endpoint, string subscriptionKey)
        {
